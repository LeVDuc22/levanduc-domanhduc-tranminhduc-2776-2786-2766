...
#define fixed_point_to_i_0(x) ((x) / fp_f)

/* Convert x to integer (rounding to nearest). */
#define fixed_point_to_i(x) (((x) > 0) ? (fixed_point_to_i_0((x) + fp_f / 2)) : (fixed_point_to_i_0((x)-fp_f / 2)))
...
/* Multiply x by y. */
#define fp_mul_fp(x, y) ((fixed_point_t)(((intmax_t)(x)) * (y) / fp_f))

/* Multiply x by n. */
#define fp_mul_i(x, n) ((x) * (n))

/* Divide x by y. */
#define fp_div_fp(x, y) ((fixed_point_t)(((intmax_t)(x)) * fp_f / (y)))
